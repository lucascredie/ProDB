UPDATE prot_db.disease SET symptoms = 'Symmetric proximal muscle weakness Malaise, fatigue Dark-colored urine (suggests myoglobinuria) and/or fever Absence of sensory complaints or paresthesias; however, deep tendon reflexes (DTRs) may be diminished/absent in hypokalemic paralysisVery late findings: Atrophy and hyporeflexia (early presence usually implicates neuropathies)Normal level of consciousness Gottron papules in dermatomyositis: Pink-to-violaceous scaly areas over knuckles, elbows, and knees', prognosis = ' If the underlying cause of the myopathy can be treated successfully, as in the case of endocrine myopathies, the prognosis is usually good. Progressive myopathies that develop later in life usually have a better prognosis than conditions that develop during childhood.
Patients with Duchenne MD rarely live beyond their middle to late 20s. Patients with Becker MD may live until middle age. ', treatment = 'Treatment for myopathies depends on the cause. The goals of myopathy treatment are to slow progression of the disease and relieve symptoms.
...
', description = 'Mitochondrial encephalomyopathy, lactic acidosis, and stroke-like episodes (MELAS) is one of the family of mitochondrial cytopathies, which also include MERRF, and Lebers hereditary optic neuropathy. It was first characterized under this name in 1984. A feature of these diseases is that they are caused by defects in the mitochondrial genome which is inherited purely from the female parent.[2] However, it is important to know that some of the proteins essential to normal mitochondrial function are produced by the nuclear genome, and are subsequently transported to the mitochondria for use. As such, mutations in these proteins can result in mitochondrial disorders, but can be inherited from both male and female parent in the typical fashion. The disease can manifest in both sexes.', prot_name = 'groEL' WHERE name = 'mitochondrial encephalopathy';
UPDATE prot_db.disease SET symptoms = '  The most common early symptom of Alzheimers is difficulty remembering newly learned information because Alzheimers changes typically begin in the part of the brain that affects learning. As Alzheimers advances through the brain it leads to increasingly severe symptoms, including disorientation, mood and behavior changes; deepening confusion about events, time and place; unfounded suspicions about family, friends and professional caregivers; more serious memory loss and behavior changes; and difficulty speaking, swallowing and walking. ', prognosis = ' null', treatment = 'Currently, there is no cure for Alzheimers. But drug and non-drug treatments may help with both cognitive and behavioral symptoms.

Researchers are looking for new treatments to alter the course of the disease and improve the quality of life for people with dementia. ', description = ' Two abnormal structures called plaques and tangles are prime suspects in damaging and killing nerve cells.
...
Its the destruction and death of nerve cells that causes memory failure, personality changes, problems carrying out daily activities and other symptoms of Alzheimers disease.', prot_name = 'acetylcholinesterase' WHERE name = 'Alzheimers';
UPDATE prot_db.disease SET symptoms = 'There are five primary motor symptoms of Parkinson’s disease: tremor, rigidity, bradykinesia (slow movement), postural instability (balance problems), and walking/gait problems. Observing one or more of these symptoms is the main way that physicians diagnose Parkinson’s.

It is important to know that not all of these symptoms must be present for a diagnosis of Parkinson’s disease to be considered. In fact, younger people may only notice one or two of these motor symptoms, especially in the early stages of the disease. Not everyone with Parkinson’s disease has a tremor, nor is a tremor proof of Parkinson’s. If you suspect Parkinson’s, see a neurologist or movement disorders specialist. ', prognosis = ' null ', treatment = ' null', description = ' Parkinsons disease (PD) is a chronic and progressive disease of the central nervous system, meaning the symptoms will continue and worsen over time. Approximately 1–1.5 million people in the United States currently have PD. It is estimated that approximately 60,000 Americans are diagnosed with PD each year.
...
Chest pain
Cold hands and feet
Headache', prognosis = ' null', treatment = 'High iron diet', description = '     Anemia is a condition in which you dont have enough healthy red blood cells to carry adequate oxygen to the bodys tissues. Having anemia may make you feel tired and weak.
...
Treatments for anemia range from taking supplements to undergoing medical procedures. You may be able to prevent some types of anemia by eating a healthy, varied diet.', prot_name = 'hemoglobin' WHERE name = 'anemia';
UPDATE prot_db.disease SET symptoms = '    umbilical cord bleeding at birth.
unexplained bruising.
abnormal bleeding after giving birth, having surgery, or being injured.
prolonged nose bleeds.
bleeding from the gums.
heavy or prolonged menstrual periods.', prognosis = ' Prothrombin difficiency can lead to death due to the bodies inability to clot.  ', treatment = 'Controlling Bleeding
...
If you are planning any surgeries or invasive procedures, infusions of clotting factor or other treatments may be required to minimize bleeding risks', description = '   Prothrombin deficiency is a bleeding disorder that slows the blood clotting process. People with this condition often experience prolonged bleeding following an injury, surgery, or having a tooth pulled. In severe cases of prothrombin deficiency, heavy bleeding occurs after minor trauma or even in the absence of injury (spontaneous bleeding). Women with prothrombin deficiency can have prolonged and sometimes abnormally heavy menstrual bleeding. Serious complications can result from bleeding into the joints, muscles, brain, or other internal organs. Milder forms of prothrombin deficiency do not involve spontaneous bleeding, and the condition may only become apparent following surgery or a serious injury.      ', prot_name = 'thrombin' WHERE name = 'prothrombin difficiency';
UPDATE prot_db.disease SET symptoms = 'Signs and symptoms of pulmonary fibrosis may include:
...
Lung transplantation may be an option for people with pulmonary fibrosis. Having a lung transplant can improve your quality of life and allow you to live a longer life. However, a lung transplant can involve complications such as rejection and infection. Your doctor may discuss with you if a lung transplant may be appropriate for your condition.', description = 'Pulmonary fibrosis is a lung disease that occurs when lung tissue becomes damaged and scarred. This thickened, stiff tissue makes it more difficult for your lungs to work properly. As pulmonary fibrosis worsens, you become progressively more short of breath.
...
The lung damage caused by pulmonary fibrosis cant be repaired, but medications and therapies can sometimes help ease symptoms and improve quality of life. For some people, a lung transplant might be appropriate.', prot_name = 'integrin' WHERE name = 'fibrosis';
UPDATE prot_db.disease SET symptoms = '  Atherosclerosis develops gradually. Mild atherosclerosis usually doesnt have any symptoms.
...
If you have atherosclerosis in the arteries leading to your kidneys, you develop high blood pressure or kidney failure.', prognosis = ' null', treatment = 'Treatment
...
Bypass surgery. Your doctor may create a graft bypass using a vessel from another part of your body or a tube made of synthetic fabric. This allows blood to flow around the blocked or narrowed artery.     ', description = ' Arteriosclerosis occurs when the blood vessels that carry oxygen and nutrients from your heart to the rest of your body (arteries) become thick and stiff — sometimes restricting blood flow to your organs and tissues. Healthy arteries are flexible and elastic, but over time, the walls in your arteries can harden, a condition commonly called hardening of the arteries.
